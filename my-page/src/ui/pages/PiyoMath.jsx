...
export default function PiyoMath(){
    return (
        <Container>
          ...
          <Typography variant="body1" gutterBottom>
            <p>This privacy policy applies to the Piyo Math app (hereby referred to as "Application") for mobile devices that was created by Daiki Kaneda (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".</p>
          </Typography>
          ...
          <Typography variant="body1" gutterBottom>
            ...
            <p>The Service Provider does not knowingly collect personally identifiable information from children. The Service Provider encourages all children to never submit any personally identifiable information through the Application and/or Services. The Service Provider encourages parents and legal guardians to monitor their children's Internet usage and to help enforce this Policy by instructing their children never to provide personally identifiable information through the Application and/or Services without their permission. If you have reason to believe that a child has provided personally identifiable information to the Service Provider through the Application and/or Services, please contact the Service Provider (piyomathfeedback@gmail.com) so that they will be able to take the necessary actions. You must also be at least 16 years of age to consent to the processing of your personally identifiable information in your country (in some countries we may allow your parent or guardian to do so on your behalf).</p>
          </Typography>
          <Typography variant="h6" component="h2" gutterBottom>
            Security
          </Typography>
          ...
          <Typography variant="body1" gutterBottom>
            <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at piyomathfeedback@gmail.com.</p>
          </Typography>
          <hr />
        </Container>
      );
